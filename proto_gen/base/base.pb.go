...
type BaseResponse struct {
	...
	Code    int32             `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`                                                                                           // response status code
	Message string            `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`                                                                                      // response message
	Detail  string            `protobuf:"bytes,3,opt,name=detail,proto3" json:"detail,omitempty"`                                                                                        // response detail message
	Extra   map[string]string `protobuf:"bytes,15,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // extra data
}
...
var file_base_base_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x62, 0x61, 0x73, 0x65, 0x22, 0xc3, 0x01, 0x0a, 0x0c, 0x42, 0x61, 0x73, 0x65,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x33,
	0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e,
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x31, 0x5a,
	0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x71, 0x69, 0x6e, 0x67, 0x39, 0x38, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x67, 0x65,
	0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x61, 0x73, 0x65,
...
var file_base_base_proto_goTypes = []interface{}{
	...
	nil,                  // 1: base.BaseResponse.ExtraEntry
}
var file_base_base_proto_depIdxs = []int32{
	1, // 0: base.BaseResponse.extra:type_name -> base.BaseResponse.ExtraEntry
